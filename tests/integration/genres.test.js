...
describe("/api/genres", () => {
  ...
  describe("PUT /:id", () => {
    ...
    test("should return 404 if genre with the given id was not found", async () => {
    ...
    test("should update the genre if input is valid", async () => {
      await exec();
    ...
    test("should return the updated genre if it is valid", async () => {
      ...
      expect(updatedGenre).toHaveProperty("name", newName);
    });
  });
  ...
  describe("DELETE /:id", () => {
    ...
    test("should return 404 if no genre with the given id was found", async () => {
      id = mongoose.Types.ObjectId();
    ...
    test("should delete the genre if input is valid", async () => {
      await exec();
    ...
    test("should return the removed genre", async () => {
      const res = await exec();
